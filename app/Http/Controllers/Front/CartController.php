...
class CartController extends Controller
{
    ...
    public function index()
    {
        ...
        // dd($this->cartRepo->getCartItemsTransformed(), $this->cartRepo->getTax());
    ...
    {
        foreach($request->cart_item as $key => $item)
        {
            $this->cartRepo->updateQuantityInCart($item, $request->quantity[$key]);
        }
