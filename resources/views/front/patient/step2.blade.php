        ...
        <div class="col-12">
            <div class="row">
                ...
                <div class="col-md-6 select-facility select-option mb-3">
                    ...
                    <select id="ans1" name="ans1" class="selectpicker form-control show-tick" data-actions-box="true" data-style="btn-outline-primary" title="Select Option" required> 
            ...
            <div class="row">
                ...
                <div class="col-md-6 select-facility select-option mb-3">
                    <select id="ans2" name="ans2" class="selectpicker form-control show-tick" data-actions-box="true" data-style="btn-outline-primary" title="Select Option" required>
            ...
            <div class="row">
                ...
                <div class="col-md-6 select-facility select-option mb-3">
                        {{-- add "multiple" attribute for multi-selection --}}
                    <select id="ans3" name="ans3" class="selectpicker form-control show-tick" data-actions-box="true" data-style="btn-outline-primary" title="Select Option" required>
            ...
            <div class="row">
                ...
                <div class="col-md-6 select-facility select-option mb-3">
                        <select id="ans4" name="ans4" class="selectpicker form-control show-tick" data-actions-box="true" data-style="btn-outline-primary" title="Select Option" required> 
            ...
            <div class="row">
                ...
                <div class="col-md-6 select-facility select-option mb-3">
                <select id="ans5" name="ans5" class="selectpicker form-control show-tick" data-actions-box="true" data-style="btn-outline-primary" title="Select Option" required>
            ...
            <div class="row">
                ...
                <div class="col-md-6 select-facility select-option mb-3">
                    <select id="ans6" name="ans6" class="selectpicker form-control show-tick" data-actions-box="true" data-style="btn-outline-primary" title="Select Option" required>
            ...
            <div class="row">
                ...
                <div class="col-md-6 select-facility select-option mb-3">
                    <select id="ans7" name="ans7" class="selectpicker form-control show-tick" data-actions-box="true" data-style="btn-outline-primary" title="Select Option" required>
            ...
            <div class="row">
                ...
                <div class="col-md-6 select-facility select-option mb-3">
                    <select id="ans8" name="ans8" class="selectpicker form-control show-tick" data-actions-box="true" data-style="btn-outline-primary" title="Select Option" required>
            ...
            <div class="row">
                ...
                <div class="col-md-6 select-facility select-option mb-3">
                    <select id="ans9" name="ans9" class="selectpicker form-control show-tick" data-actions-box="true" data-style="btn-outline-primary" title="Select Option" required> 
            ...
            <div class="row">
                ...
                <div class="col-md-6 select-facility select-option mb-3">
                    <select id="ans10" name="ans10" class="selectpicker form-control show-tick" data-actions-box="true" data-style="btn-outline-primary" title="Select Option" required>
            ...
            <div class="row">
                ...
                <div class="col-md-6 select-facility select-option mb-3">
                    <select id="ans11" name="ans11" class="selectpicker form-control show-tick" data-actions-box="true" data-style="btn-outline-primary" title="Select Option" required>
            ...
            <div class="row">
                ...
                <div class="col-md-6 select-facility select-option mb-3">
                    <select id="ans12" name="ans12" class="selectpicker form-control show-tick" data-actions-box="true" data-style="btn-outline-primary" title="Select Option" required>
            ...
            <div class="row">
                ...
                <div class="col-md-6 select-facility select-option mb-3">
                    <select id="ans13" name="ans13" class="selectpicker form-control show-tick" data-actions-box="true" data-style="btn-outline-primary" title="Select Option" required>
            ...
            <div class="row">
                ...
                <div class="col-md-6 select-facility select-option mb-3">
                    <select id="ans14" name="ans14" class="selectpicker form-control show-tick" data-actions-box="true" data-style="btn-outline-primary" title="Select Option" required>
            ...
            <div class="row">
                ...
                <div class="col-md-6 select-facility select-option mb-3">
                    <select id="ans15" name="ans15" class="selectpicker form-control show-tick" data-actions-box="true" data-style="btn-outline-primary" title="Select Option" required>
            ...
            <div class="row">
                ...
                <div class="col-md-6 select-facility select-option mb-3">
                    <select id="ans16" name="ans16" class="selectpicker form-control show-tick" data-actions-box="true" data-style="btn-outline-primary" title="Select Option" required>
            ...
            <div class="row">
                ...
                <div class="col-md-6 select-facility select-option mb-3">
                    <select id="ans17" name="ans17" class="selectpicker form-control show-tick" data-actions-box="true" data-style="btn-outline-primary" title="Select Option" required>
            ...
            <div class="row">
                ...
                <div class="col-md-6 select-facility select-option mb-3">
                    <select id="ans18" name="ans18" class="selectpicker form-control show-tick" data-actions-box="true" data-style="btn-outline-primary" title="Select Option" required>
            ...
            <div class="row">
                ...
                <div class="col-md-6 select-facility select-option mb-3">
                    <select id="ans19" name="ans19" class="selectpicker form-control show-tick" data-actions-box="true" data-style="btn-outline-primary" title="Select Option" required>
