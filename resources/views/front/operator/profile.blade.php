                                    ...
                                    <div class="profile-sidebar">
                                        ...
                                        <div class="portlet light profile-sidebar-portlet ">
                                            ...
                                            <div class="profile-userpic">
                                                <img src="{{ asset('storage/' . $user->avatar) }}" class="img-responsive" alt=""> </div>
                                            <!-- END SIDEBAR USERPIC -->
                                            <!-- SIDEBAR USER TITLE -->
                                                ...
                                                <div class="portlet light ">
                                                    <div class="portlet-title tabbable-line">
                                                        ...
                                                        <ul class="nav nav-tabs">
                                                            ...
                                                            {{-- <li>
                                                                <a href="#tab_1_5" data-toggle="tab">Payment Details</a>
                                                            </li> --}}
                                                            <li>
                                                    ...
                                                    <div class="portlet-body">
                                                        <div class="tab-content">
                                                            ...
                                                            <div class="tab-pane active" id="tab_1_1">
                                                                <form role="form" action="{{ route('operator.personal_info') }}" method="POST">
                                                                    @csrf
                                                                    ...
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input type="text" placeholder="+1 646 580 DEMO (6284)" name="phone" value="{{ $user->phone }}" class="form-control" /> </div>
                                                                    <div class="form-group">
                                                                        <label class="control-label">Email</label>
                                                                        <input type="email" placeholder="Email" readonly class="form-control" value="{{ $user->email }}" /> </div>
                                                                    <div class="form-group">
                                                                        <label class="control-label">Zip Code</label>
                                                                    <input type="number" name="zipcode" placeholder="Zip code" @if($user->zipcode) readonly @endif value="{{ $user->zipcode }}" class="form-control" required /> </div>
                                                            ...
                                                            <div class="tab-pane" id="tab_1_2">
                                                                <form action="{{ route('employee.updateAvatar') }}" method="POST" role="form" enctype="multipart/form-data">
                                                                    @csrf
                                                                    <div class="form-group">
