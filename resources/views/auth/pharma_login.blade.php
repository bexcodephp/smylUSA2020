...
<section class="page-header">
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-12">
                <h1 class="font-weight-bold">Pharmacist Login / Signup</h1>
            ...
            <div class="row">
                ...
                <div class="col-md-6 col-lg-5 col-xl-4 mb-5 mb-md-0">
                    <div class="bg-primary rounded p-5">
                        ...
                        <form  id="shopLoginSignIn" role="form" method="POST" action="{{ route('pharma_login') }}">
                        {{ csrf_field() }}
                            <div class="form-row">
                ...
                <div class="col-md-6 col-lg-7 col-xl-8 pt-3">
                    ...
                    <br>
                    <form  id="shopLoginRegister" role="form" method="POST" action="{{ route('pharma_register') }}">
                        {{ csrf_field() }}
                        <div class="form-row">
