...
<section class="page-header">
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-12">
                <h1 class="font-weight-bold">Dentist Login / Signup</h1>
    ...
    <section class="section">
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-5 col-md-offset-3 mb-5 mb-md-0">
                ...
                <div class="col-md-7 col-md-offset-3 mb-5 mb-md-0">
                    <span class="top-sub-title">NEW USER</span>
                    <h2 class="font-weight-bold text-4 mb-1">Don't have an account? Register Now!</h2>
                    <br>
                    <form  id="shopLoginRegister" role="form" method="POST" action="{{ route('dentist_register') }}">
                        {{ csrf_field() }}
                        <div class="form-row">
                            ...
                            <div class="form-group col-lg-6">
                                ...
                                <input type="email" value="" class="form-control bg-light-5 border-0 rounded" autocomplete="off" name="email"
                                       id="shopLoginRegisterEmail" required>
                            </div>
                        </div>
                        <div class="form-row">
                            <div class="form-group col-lg-4">
                                <label class="text-color-dark" for="shopLoginRegisterPhone">PHONE:</label>
                                <input type="text" value="" placeholder = "+1 (123) 456–7890" autocomplete="off" class="form-control bg-light-5 border-0 rounded" name="phone" id="shopLoginRegisterPhone" required>
                            </div>
                            <div class="form-group col-lg-4">
                                <label class="text-color-dark" for="shopLoginRegisterPhone">States:</label>
                                <select name="state" class="form-control bg-light-5 border-0 rounded">
                            ...
                            <div class="form-group col-lg-4">
                                ...
                                <input type="password" value="" class="form-control bg-light-5 border-0 rounded" autocomplete="off" name="password" id="shopLoginRegisterPassword" required>
                            </div>
                        </div>
                        <div class="form-row">
                            <div class="col text-right">
