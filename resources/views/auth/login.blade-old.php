...
<section class="page-header">
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-12">
                <h1 class="font-weight-bold">Login / Signup</h1>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-6 col-lg-7 col-xl-8 pt-3">
                    ...
                    <br>
                    <form  id="shopLoginRegister" role="form" method="POST" action="{{ route('register') }}">
                        {{ csrf_field() }}
                        <div class="form-row">
                            <div class="form-group col-lg-6">
                                <label class="text-color-dark" for="first_name">First Name:</label>
                                <input type="text" value="" class="form-control bg-light-5 border-0 rounded" autocomplete="off" name="first_name" id="first_name" required>
                            </div>
                            <div class="form-group col-lg-6">
                                <label class="text-color-dark" for="last_name">Last Name:</label>
                                <input type="text" value="" class="form-control bg-light-5 border-0 rounded" autocomplete="off" name="last_name" id="last_name"
                                    required>
                            </div>
                        </div>
                        <div class="form-row">
