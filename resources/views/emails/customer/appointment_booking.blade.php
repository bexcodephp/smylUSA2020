...
<body marginwidth="0" marginheight="0" style="margin-top: 0; margin-bottom: 0; padding-top: 0; padding-bottom: 0; width: 100%; -webkit-text-size-adjust: 100%; -ms-text-size-adjust: 100%;" offset="0" topmargin="0" leftmargin="0">
					...
					<table class="table600" width="600" border="0" cellpadding="0" cellspacing="0">
						...
						<tr>
							<td align="justify" style="font-family: 'Open Sans', sans-serif; font-size: 13px; font-weight: 400; color: #8f96a1; line-height: 24px;">
								Dear <strong>{{ $appointment->customer->name }}</strong>, 
								<br>
								<br><b>Your appointment has been confirmed</b><br><br>
								
								Appointment No: {{  $appointment->appointment_id }}<br>
								Appointment Date: {{ date('D, d, M', strtotime($appointment->weekday)) }}<br>
							
								Appointment Time: {{ date('H:i A', strtotime($appointment->schedule_time)) }}<br>
							
								Location:
								{{ $appointment->facility->city . ", " . $appointment->facility->state . ", " . $appointment->facility->address }}<br>
							
								Facility Phone:
								{{ $appointment->facility->phone }}<br><br>
							</td>
						</tr>
						...
						@if($password)
							<tr>
								<td align="justify" style="font-family: 'Open Sans', sans-serif; font-size: 13px; font-weight: 400; color: #8f96a1; line-height: 24px;">
									We've created a temporary password for your account. <br>
									Password: {{ $password }}
								</td>
							</tr>
								...
								<table align="center" border="0" cellpadding="0" cellspacing="0" style="border-radius: 2px;" bgcolor="#26c6da">
									<tr>
										<td align="center" height="44" style="font-family: 'Open Sans', sans-serif; font-size: 14px; font-weight: 600; color: #ffffff; line-height: 24px; padding-left: 53px; padding-right: 53px;">
											<a href="{{ url('login') }}" style="text-decoration: none; color: #ffffff;">
												Login Now
											</a>
										</td>
									</tr>
	...
	<table width="100%" align="center" border="0" cellpadding="0" cellspacing="0">
		<tr>
			<!-- Background -->
			<td align="center" bgcolor="#333333" background="https://smylusa.com/images/bg-main-b.jpg" style="background-size: cover; background-position: center;">
				<table class="table600" width="600" border="0" cellpadding="0" cellspacing="0">
