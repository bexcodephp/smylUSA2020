					...
					<table class="table600" width="600" border="0" cellpadding="0" cellspacing="0">
						...
						<tr>
							<td align="center"
								...
								What’s the next step of your SMYL journey?
							</td>
						</tr>
						...
						<tr>
							<td align="justify" style="font-family: 'Open Sans', sans-serif; font-size: 13px; font-weight: 400; color: #8f96a1; line-height: 24px;">
								...
								<br>
								<br>
								Now that you have successfully registered and figured out if you are a candidate for our clear aligners, you are ready
								to take the leap!
								<br>
								<br>
								The process is simple and easy! You can get our impression kit and go through the whole process from the comfort of your
								home!
								<br>
								<br>
								Here’s how it works!
								<ul style="list-style-type: decimal">
									<li>You buy it, we ship it! Simply order through our website and leave the rest to us.</li>
									<li>Take less than 30 minutes to complete the impression from the comfort of your home</li>
									<li>Mail the kit back to us and get the aligners shipped back to you! No routine visits needed!</li>
								</ul>
								<br>
								<br>
