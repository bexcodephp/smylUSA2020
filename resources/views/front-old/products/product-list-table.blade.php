@if(!$products->isEmpty())
    <table class="table table-striped">
        ...
        <tr>
            ...
            <td class="bg-warning"></td>
            <td class="bg-warning"></td>
            <td class="bg-warning">{{config('cart.currency_symbol')}} {{ number_format($subtotal, 2, '.', ',') }}</td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td class="bg-success"></td>
            <td class="bg-success"></td>
            <td class="bg-success">{{config('cart.currency_symbol')}} <span id="grandTotal" data-total="{{ $total }}">{{ number_format($total, 2, '.', ',') }}</span></td>
        </tr>
        </tfoot>
        <tbody>
        @foreach($cartItems as $cartItem)
            <tr>
                ...
                <td>{{config('cart.currency_symbol')}} {{ number_format($cartItem->price, 2) }}</td>
            </tr>
        @endforeach
        </tbody>
    </table>
