                                                    ...
                                                    <div class="portlet-body">
                                                        ...
                                                        <div class="tab-content">
                                                            ...
                                                            <div class="tab-pane active" id="tab_1_1">
                                                                <form role="form" action="{{ route('vendor.personal_info') }}" method="POST">
                                                                    @csrf
                                                            ...
                                                            <div class="tab-pane" id="tab_1_2">
                                                                <form action="{{ route('vendor.updateAvatar') }}" method="POST" role="form" enctype="multipart/form-data">
                                                                    @csrf
                                                                    <div class="form-group">
